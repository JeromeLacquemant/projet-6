...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'username', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', 'confirm_password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'image', '' . "\0" . 'App\\Entity\\User' . "\0" . 'users', '' . "\0" . 'App\\Entity\\User' . "\0" . 'authors', '' . "\0" . 'App\\Entity\\User' . "\0" . 'activation_token', '' . "\0" . 'App\\Entity\\User' . "\0" . 'reset_token'];
        }
     ...
     * {@inheritDoc}
     */
    public function addAuthor(\App\Entity\User $author): \App\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function removeAuthor(\App\Entity\User $author): \App\Entity\User
    {
