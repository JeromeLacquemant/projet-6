...
class __TwigTemplate_525052826a5a811dc03c63f75b68cac46b97ca5c04c6e482d351737f161657fd extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"sf-tabs\">
        ...
        echo "
                ...
                ";
        // line 159
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "content", [], "any", false, false, false, 159), false))) {
            // line 160
            echo "                    <div class=\"empty\">
...
";
        ...
        try {
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["controller"] ?? null), "class", [], "any", true, true, false, 323)) {
                ...
                if ((((isset($context["route"]) || array_key_exists("route", $context))) ? (_twig_default_filter(($context["route"] ?? null), false)) : (false))) {
                    ...
                    // line 331
                    echo twig_escape_filter($this->env, strip_tags($this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(twig_get_attribute($this->env, $this->source, ($context["controller"] ?? null), "class", [], "any", false, false, false, 331))), "html", null, true);
                    // line 332
    ...
    {
        return new Source("", "@WebProfiler/Collector/request.html.twig", "/Users/jerome/Documents/OpenClassRooms/0_Projets/P6_LACQUEMANT_Jérôme/1_Documents de travail/Snowtricks_Netbeans/vendor/symfony/web-profiler-bundle/Resources/views/Collector/request.html.twig");
    }
}
